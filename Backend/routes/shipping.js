...
exports.getShippingRate = async (req, res) => {
  try {
    ...
    // NEW weight calculation based on selected product weight
    const calculatedWeight = cart.reduce((sum, item) => {
      let itemWeight = 0.25; // default
    ...
    const weight = Math.max(0.25, calculatedWeight);
